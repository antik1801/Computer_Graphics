...
int light=1,day=1,plane=0,comet=0,xm=900,train=0,board=1,village=1,evening=1;
char ch;
//text rendering
...
{
    GLint points = 80;
    GLdouble delTheta = (5.0 * PI) / (GLdouble)points;
    GLdouble theta = 0.0;
...
void draw_object()
{
    ...
    glVertex2f(0,380); //2
    glVertex2f(0,700); //1
    glVertex2f(1100,700);//4
    glVertex2f(1100,380);//3
    glEnd();
        ...
        for(l=0;l<=75;l++)//size
    {
            ...
            draw_circle(200,625,l);//position
    }
    ...
    if(plane==1)
    {
        ...
        glBegin(GL_POLYGON);
        glVertex2f(825+n,625+o);
        glVertex2f(900+n,640+o);
...
glEnd();
	...
	for(l=0;l<=30;l++)
	{
		...
		draw_circle(40,300,l);
		draw_circle(80,300,l);
	}

	for(l=0;l<=25;l++)
	{
		glColor3f(0.0,0.5,0.0);
		draw_circle(50,340,l);
		draw_circle(70,340,l);
	}

	for(l=0;l<=20;l++)
	{
		glColor3f(0.0,0.5,0.0);
		draw_circle(60,365,l);
	}
...
//railway station
glColor3f(0.947059,0.864706,0.564706);
glBegin(GL_POLYGON);
glVertex2f(400,250);
glVertex2f(400,450);
glVertex2f(950,450);
...
//roof
glColor3f(0.556863,0.519608,0.137255);
glBegin(GL_POLYGON);
glVertex2f(350,450);
glVertex2f(350,500);
glVertex2f(1000,500);
...
//side window
glColor3f(0.5,0.419608,0.137255);
glBegin(GL_POLYGON);
glVertex2f(950,400);
glVertex2f(1000,350);
glVertex2f(950,350);
...
glEnd();
glColor3f(1.0,1.0,1.0);
     glRasterPos2f(530,520);
     declare(" DHAKA RAILWAY STATION ");
